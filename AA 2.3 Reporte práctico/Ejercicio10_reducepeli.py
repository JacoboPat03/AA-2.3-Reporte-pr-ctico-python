lista_peliculas = [
  ...
  },
  {
    ...
    "Año": "2014",
    "Clasificación": "PG-13",
    "Estreno": "07 de noviembre de 2014",
    "Duración": "169 min",
  ...
  },
  {
    ...
    "Año": "2005",
    "Clasificación": "PG-13",
    "Estreno": "15 de junio de 2005",
    "Duración": "140 min",
    "Género": "Acción, Aventura",
    "Director": "Christopher Nolan",
    "Guionista": "Bob Kane, David S. Goyer, Christopher Nolan",
    "Actores": "Christian Bale, Michael Caine, Liam Neeson, Katie Holmes",
    "Trama": "Después de entrenar con su mentor, Batman comienza su lucha para liberar a Gotham City del crimen y la corrupción impuesta por los Espantapájaros y la Liga de las Sombras.",
...
# Filtrar y mapear las películas de Christopher Nolan
peliculas_nolan = list(
    map(
        lambda pelicula: {
            "Título": pelicula["Título"],
            "CalificaciónIMDB": float(pelicula["CalificaciónIMDB"])
        },
        filter(
            lambda pelicula: pelicula["Director"] == "Christopher Nolan",
            lista_peliculas
        )
    )
)
