...
CalificacionFor = [{"titulo": pelicula["Título"], "calificacion": pelicula["CalificaciónIMDB"]} for pelicula in lista_peliculas] 

calificacionesMap = list(map(lambda pelicula: {"titulo": pelicula["Título"], "calificacion": pelicula["CalificaciónIMDB"]}, lista_peliculas))
print(calificacionesMap)
print(CalificacionFor)